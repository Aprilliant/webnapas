...
<div>
    <h1 class="mx-10">Tambah Barang</h1>
</div>

<div class="mx-10 mt-10">

    <form method="POST" action="{{ route('barang.index') }}" enctype="multipart/form-data">
        ...
        <div class="grid gap-6 mb-6 md:grid-cols-2">
            <div>
                ...
                <input type="text" id="nama_barang"
                    ...
                    required autofocus name="nama_barang">
        ...
        <button type="submit" onclick="swal('Good job!', 'Obat Berhasil Ditambahkan!', 'success')"
