            ...
            <tr class="bg-white border-b dark:bg-gray-900 dark:border-gray-700">
                ...
                <td class="py-4 px-6">
                    <div class="flex">
                        ...
                        <a href="barang/{{ $barang[0]->id }}/edit " class="mx-2">
                            <span
                                class="bg-blue-100 text-blue-800 text-xs font-medium inline-flex items-center px-2.5 py-0.5 rounded dark:bg-blue-200 dark:text-blue-800">
                                <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24"
                                    style="fill: rgba(0, 0, 0, 1);transform: ;msFilter:;">
                        ...
                        <form action="{{ route('barang.destroy',$barang[0]->id) }}" method="POST">
                            @method('delete')
                            @csrf


                            <button id="delete" type="button" onclick="deleteArtikel({{  $barang[0]->id }})"><span
            ...
            <tr class="bg-white border-b dark:bg-gray-900 dark:border-gray-700">
                ...
                <td class="py-4 px-6">
                    <div class="flex">
                        ...
                        <a href="barang/{{ $obat->id }}/edit " class="mx-2">
                            <span
                                class="bg-blue-100 text-blue-800 text-xs font-medium inline-flex items-center px-2.5 py-0.5 rounded dark:bg-blue-200 dark:text-blue-800">
                                <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24"
                                    style="fill: rgba(0, 0, 0, 1);transform: ;msFilter:;">
                        ...
                        <form action="{{ route('barang.destroy',$obat->id) }}" method="POST">
                            @method('delete')
                            @csrf


                            <button id="delete" type="button" onclick="deleteArtikel({{  $obat->id }})"><span
                                    class="bg-blue-100 text-blue-800 delete text-xs font-medium inline-flex items-center px-2.5 py-0.5 rounded dark:bg-blue-200 dark:text-blue-800">
                                    <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24"
                                        style="fill: rgba(0, 0, 0, 1);transform: ;msFilter:;">
                                        <path
