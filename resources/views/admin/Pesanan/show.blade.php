...
<div class="max-w-[85rem] px-4 sm:px-6 lg:px-8 mx-auto my-4 sm:my-10">
    ...
    <div class="mb-5 pb-5 flex justify-between items-center border-b border-gray-200 dark:border-gray-700">
        <div>
            <h2 class="text-2xl font-semibold text-gray-800 dark:text-gray-200">Order Detail</h2>
        </div>
        <!-- Col -->
    ...
    <div class="mt-6 border border-gray-200 p-4 rounded-lg space-y-4 dark:border-gray-700">
        ...
        <div class="grid grid-cols-3 sm:grid-cols-5 gap-2">
            <div class="col-span-full sm:col-span-2">
                ...
                <p class="font-medium text-gray-800 dark:text-gray-200">{{ $detail->barang->nama_barang }}</p>
            </div>
            <div>
                <h5 class="sm:hidden text-xs font-medium text-gray-500 uppercase">Qty</h5>
                <p class="text-gray-800 dark:text-gray-200">{{ $detail->jumlah }}</p>
            </div>
            <div>
                <h5 class="sm:hidden text-xs font-medium text-gray-500 uppercase">Harga</h5>
                <p class="text-gray-800 dark:text-gray-200">{{ $detail->barang->harga }}</p>
            </div>
            <div>
                <h5 class="sm:hidden text-xs font-medium text-gray-500 uppercase">Amount</h5>
                <p class="sm:text-right text-gray-800 dark:text-gray-200">${{ $detail->jumlah * $detail->barang->harga
                    }}
                </p>
            </div>
        </div>
        ...
        <div class="w-full max-w-2xl sm:text-right space-y-2">
            ...
            <div class="grid grid-cols-2 sm:grid-cols-1 gap-3 sm:gap-2">
                <dl class="grid sm:grid-cols-5 gap-x-3 text-sm">
                    ...
                    <dd class="col-span-2 font-medium text-gray-800 dark:text-gray-200">{{ $pesanan->jumlah_harga }}
                    </dd>
                </dl>

                <dl class="grid sm:grid-cols-5 gap-x-3 text-sm">
                    <dt class="col-span-3 text-gray-500">Tax:</dt>
                    <dd class="col-span-2 font-medium text-gray-800 dark:text-gray-200">00</dd>
                </dl>
