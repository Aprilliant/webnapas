...
<div
    ...
    <div class="max-w-lg">
        ...
        <p class="mt-2 text-gray-600">merupakan Dokter Paru lulusan dari Fakultas Kedokteran Universitas Indonesia. Saat
            ini Dr. {{ Auth::user()->name }} masih aktif praktik untuk melayani pasien serta memberikan Konsultasi,
...
<div class="   max-w-screen-xl mx-auto p-5 sm:p-10 md:p-16">
    ...
    <div class="border-b mb-5 flex justify-between text-sm">
        <div class="text-indigo-600 flex items-center pb-2 pr-2 border-b-2 border-indigo-600 uppercase">
            ...
            <a href="#" class="font-semibold inline-block">Tambah Jadwal </a>
        </div>
        <a href="#"></a>
    </div>
    ...
    <form action="{{ route('konsultasi-langsung.store') }}" method="POST">
        @csrf
        <div class="grid gap-6 mb-6 md:grid-cols-2">
            ...
            <div>
                ...
                <label for="max_appointments"
                    class="block mb-2 text-sm font-medium text-gray-900 dark:text-white">Maksimal Jumlah
                    Pasien</label>
                <input type="text" id="max_appointments" name="max_appointments"
                    class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500">
            ...
            <div>
                ...
                <label for="time_start" class="block mb-2 text-sm font-medium text-gray-900 dark:text-white">Jam
                    Mulai</label>
            ...
            <div>
                ...
                <label for="time_end" class="block mb-2 text-sm font-medium text-gray-900 dark:text-white">Jam
                    Berahir</label>
