    ...
    <div id="navbar-default" class="mx-auto py-10 hidden md:block md:fixed md:px-16">
        ...
        <ul>
            ...
            <li class="flex space-x-2 mt-10 cursor-pointer active:text-[#EC5252] hover:text-[#EC5252] duration-150">
                ...
                <span class="font-semibold active:text-[#EC5252] "><a href="/apa-itu-tbc">Kualitas Udara</a></span>
            </li>
            ...
            <li class="flex space-x-2 mt-10 cursor-pointer active:text-[#EC5252] hover:text-[#EC5252] duration-150">
                ...
                <span class="font-bold"><a href="{{ url('konsultasi-langsung') }}">Konsultasi</span>
            </li>
            ...
            <li class="flex space-x-2 mt-10 cursor-pointer active:text-[#EC5252] hover:text-[#EC5252] duration-150">
                ...
                <span class="font-semibold "><a href="/quiz" class="">3D Penyakit</span>
            </li>
            ...
            <li class="flex space-x-2 mt-10 cursor-pointer hover:text-[#EC5252] duration-150">
                ...
                <span class="font-semibold"><a href="{{url('/obat-obatan')}}">Obat</a></span>
            </li>
